...
public class UserRepository {
	...
	public List<Order> OrderList(int id) {
		try {
			String str_query = String.format("select * from %s where %s=? order by %s desc limit 5", Views.TBL_ORDER,
					Views.COL_ORDERS_USER_ID, Views.COL_ORDERS_CREATEDATE);
